    ...
    */
    ...
    public static function createProduct($options)
    {
        ...
        $sql = 'INSERT INTO product '
            . '(id, name, category_id, code, price, availability, brand,'
            . 'image, description, is_new, is_recommended, status)'
            . 'VALUES '
            . '(NULL, :name, :category_id, :code, :price, :availability, :brand,'
    ...
    public static function updateProductById($id, $options)
    {
        ...
        // Получение и возврат результатов. Используется подготовленный запрос
        $result = $db->prepare($sql);
        var_dump($result->bindParam(':id', $id, PDO::PARAM_INT));
        ...
        var_dump($result->bindParam(':code', $options['code'], PDO::PARAM_INT));
